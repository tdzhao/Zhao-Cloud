...
import com.zhao.common.security.annotation.InnerAuth;
...
import com.zhao.system.service.ISysDeptService;
import com.zhao.system.service.ISysPermissionService;
import com.zhao.system.service.ISysPostService;
import com.zhao.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
     ...
     * @return
     */
    @PostMapping("/selectUserListNoDataScope")
    public List<SysUser> selectUserListNoDataScope(@RequestBody SysUser user)
    {
        List<SysUser> list = userService.selectUserList(user);
        return list;
    }
     ...
     */
    @InnerAuth
    @GetMapping("/getGithubInfo/{githubId}")
    public R<?> getGithubInfo(@PathVariable("githubId") String githubId)
    {
        return R.ok(userService.selectUserByGithubId(githubId));
    }
    ...
    public AjaxResult githubRegister(@RequestBody SysUser sysUser)
    {
