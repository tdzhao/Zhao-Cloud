...
create table sys_user (
  ...
  github_id         varchar(255)    default null               comment 'github_id',
  primary key (user_id)
...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://zhao.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
...
`name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品名称',
